...
instancesLoop:
	for _, instance := range instances {
		...
		launcher.removeInstanceNetworkParameters(instance, serviceInfo.ProviderID)
...
func (launcher *Launcher) removeInstanceNetworkParameters(
...
nextNetInstance:
	for _, netInstance := range networkInstances {
		...
		launcher.networkManager.RemoveInstanceNetworkParameters(netInstance, networkID)
	}
}
